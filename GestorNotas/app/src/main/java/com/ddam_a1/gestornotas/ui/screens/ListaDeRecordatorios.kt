...
import com.ddam_a1.gestornotas.ui.components.NotaDeslizable
...
fun ListaDeNotas(
    ...
    Column(modifier.fillMaxSize()) {
        ...
        // ---- Encabezado ----
        // En tu Figma el titulo dice "Mis Notas" en LAS DOS variantes,
        ...
        LazyColumn(
            ...
            items(notas, key = { it.id }) { nota ->
                ...
                val estaSeleccionada =
                    seleccionadoId != null && nota.id == seleccionadoId
