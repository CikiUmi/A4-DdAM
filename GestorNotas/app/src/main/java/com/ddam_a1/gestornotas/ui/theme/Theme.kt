package com.ddam_a1.gestornotas.ui.theme
...
fun GestorNotasTheme(
    ...
    // Dynamic color (Material You) toma los colores del fondo de pantalla
    // del usuario y PISA tu paleta. En false para que mande tu tema.
